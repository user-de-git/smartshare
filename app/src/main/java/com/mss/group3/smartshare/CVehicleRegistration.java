    ...
    public void setDateTime(View v) {
        ...
        switch (v.getId()){
            case R.id.button_setStartTime:{
                ...
                timePickerDialog = new TimePickerDialog(CVehicleRegistration.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        get_start_time.setText(hourOfDay + ":"+minute);
                    }
                },calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), android.text.format.DateFormat.is24HourFormat(CVehicleRegistration.this));
            ...
            case R.id.button_setDate:{
                ...
                datePickerDialog = new DatePickerDialog(CVehicleRegistration.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
